...
<body>
    ...
    <section class="cadastro-pet">
        ...
        <p>Cadastre seus pets para gerar um histórico básico e personalizar serviços.</p>

        <form id="formPet">
            <input type="text" id="nomePet" placeholder="Nome do pet" required>

            <select id="especiePet" required>
            ...
            <input type="number" id="idadePet" placeholder="Idade (anos)" min="0" required>

            <label>Serviços utilizados:</label>

            <div class="servicos-checkbox">
                <label><input type="checkbox" value="Banho"> Banho</label>
                <label><input type="checkbox" value="Tosa"> Tosa</label>
                <label><input type="checkbox" value="Vacinação"> Vacinação</label>
                <label><input type="checkbox" value="Consulta veterinária"> Consulta veterinária</label>
                <label><input type="checkbox" value="Adestramento"> Adestramento</label>
                <label><input type="checkbox" value="Passeio"> Passeio</label>
            </div>
    ...
    <section class="funcionalidades">
        <h2>Funcionalidades da Pet-code</h2>
    ...
    <!--videos -->
    <section class="videos-conscientizacao">
        <h2>Vídeos de Conscientização</h2>

<section class="videos-conscientizacao">
    <div class="video">
        <iframe src="https://www.youtube.com/embed/SEUVIDEO1" allowfullscreen></iframe>
    </div>

    <div class="video">
        <iframe src="https://www.youtube.com/embed/SEUVIDEO2" allowfullscreen></iframe>
    </div>

    <div class="video">
        <iframe src="https://www.youtube.com/embed/SEUVIDEO3" allowfullscreen></iframe>
    </div>
</section>
    ...
    <section class="forum">
        ...
        <form id="formPergunta">
            <input type="text" id="perguntaInput" placeholder="Faça uma pergunta..." required>
